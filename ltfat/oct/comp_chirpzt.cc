...
static inline void fwd_chzt(const Complex *fPtr, const octave_idx_type L, const octave_idx_type W,
...
static inline void fwd_chzt(const FloatComplex *fPtr, const octave_idx_type L, const octave_idx_type W,
...
static inline void fwd_chzt(const double *fPtr, const octave_idx_type L, const octave_idx_type W,
                            const octave_idx_type K, const double deltao, const double o, Complex *cPtr )
{
      chzt_d(fPtr,L,W,K,deltao,o,reinterpret_cast<double _Complex *>(cPtr));
}

static inline void fwd_chzt(const float *fPtr,const octave_idx_type L, const octave_idx_type W,
                            const octave_idx_type K, const double deltao, const double o, FloatComplex *cPtr )
{
